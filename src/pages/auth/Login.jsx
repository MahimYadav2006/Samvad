            ...
            <div className="flex flex-wrap items-center h-full">
                <div className="hidden w-full xl:block xl:w-1/2">
                    <div className="py-17.5 px-26 text-center">
                        ...
                        <p className="2xl:px-20">Hey there! Welcome Back. Login to chat with your friends.</p>
                        <span className="mt-15 inline-block">
                            <img src={LoginImagePath} alt="login" className="h-115 w-auto object-cover object-center" />
                        </span>
                    </div>
                </div>
                ...
                <div className="w-full p-6 sm:p-12 xl:p-16">
                    <span className="mb-2 block font-medium text-black dark:text-white">Start Connecting!</span>
