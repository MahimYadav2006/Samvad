            ...
            <div className="sticky flex items-center flex-row justify-between border-b dark:border-strokedark px-6 py-4.5">
                <div className="flex items-center">
                    <div className="mr-4.5 h-13 w-full max-w-13 overflow-hidden rounded-full">
                        <img src={User01} alt="avatar" className='w-full h-full object-cover object-center' />
                    </div>
                    <div>
            ...
            <div className='max-h-full space-y-3.5 overflow-auto no-scrollbar px-6 py-7.5 grow'>
                ...
                <div className='max-w-125 ml-auto text-right w-fit'>
                    <div className='rounded-2xl mb-2.5 rounded-br-none bg-primary px-5 py-3 '>
                        <p className='text-white'>I will check my schedule and will let you know by tonight.</p>
                    </div>
                    <p className='text-xs'>1:55pm</p>
                </div>
                ...
                <div className='max-w-125 ml-auto text-right w-fit'>
                    <div className='rounded-2xl mb-2.5 rounded-br-none bg-primary px-5 py-3 '>
                        <p className='text-white'>Not possible already busy in a meeting.</p>
                    </div>
                ...
                <div className='max-w-125 ml-auto text-right w-fit'>
                    <div className='rounded-2xl mb-2.5 rounded-br-none bg-primary px-5 py-3 '>
                        <p className='text-white'>Yes it is possible but just for 50 minutes.</p>
                    </div>
                ...
                <div className='max-w-125 ml-auto text-right w-fit'>
                    <div className='rounded-2xl mb-2.5 rounded-br-none bg-primary px-5 py-3 '>
                        <p className='text-white'>Sent you meeting link through mail. Pls check.</p>
                    </div>
